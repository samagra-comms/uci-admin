    ...
    ***************************************************************************** */
    ...
    var GlobalService = /** @class */ (function () {
        function GlobalService() {
            ...
            this.nlBaseUrl = new rxjs.BehaviorSubject(undefined);
            ...
            this.broadcastAdapterId = new rxjs.BehaviorSubject('');
            this.adapterId = new rxjs.BehaviorSubject('');
        ...
        GlobalService.ɵprov = core.ɵɵdefineInjectable({ factory: function GlobalService_Factory() { return new GlobalService(); }, token: GlobalService, providedIn: "root" });
    ...
    var BaseService = /** @class */ (function () {
        ...
        BaseService.prototype.patchRequest = function (url, data, headers) {
            ...
            if (headers === void 0) { headers = {}; }
            headers = __assign(__assign({}, headers), this.getDefaultHeaders());
            return this.http.patch(url, data, { headers: headers }).pipe(operators.map(function (res) {
                return res.result;
            }), operators.catchError(function (err) {
                return _this.handleError(err);
            }));
        ...
        BaseService.prototype.deleteRequest = function (url, headers) {
            ...
            if (headers === void 0) { headers = {}; }
            headers = __assign(__assign({}, headers), this.getDefaultHeaders());
            return this.http.delete(url, { headers: headers }).pipe(operators.map(function (res) {
                return res.result;
            }), operators.catchError(function (err) {
                return _this.handleError(err);
            }));
    ...
    var UciEventsService = /** @class */ (function () {
        ...
        UciEventsService.ɵprov = core.ɵɵdefineInjectable({ factory: function UciEventsService_Factory() { return new UciEventsService(); }, token: UciEventsService, providedIn: "root" });
    ...
    var Helper = /** @class */ (function () {
        ...
        Helper.ɵprov = core.ɵɵdefineInjectable({ factory: function Helper_Factory() { return new Helper(); }, token: Helper, providedIn: "root" });
        Helper = __decorate([
            core.Injectable({
                providedIn: 'root'
            })
    ...
    var ConversationAddComponent = /** @class */ (function () {
        function ConversationAddComponent(uciService, router, activatedRoute, fb, globalService, toasterService, dialog) {
            ...
            this.isStartingMessageExist = new rxjs.BehaviorSubject(false);
        ...
        ConversationAddComponent.prototype.ngOnInit = function () {
            ...
            this.conversationForm = this.fb.group({
                ...
                endDate: [null],
                segmentId: ['', forms.Validators.required],
                status: ['enabled']
            });
            // Edit case
        ...
        __decorate([
            core.ViewChild('horizontalStepper')
        ], ConversationAddComponent.prototype, "horizontalStepper", void 0);
        __decorate([
            core.ViewChild('verticalStepper')
    ...
    var AddLogicComponent = /** @class */ (function () {
        ...
        AddLogicComponent = __decorate([
            ...
            __param(5, core.Inject(dialog.MAT_DIALOG_DATA))
        ], AddLogicComponent);
    ...
    exports.UciModule = UciModule;
    exports.provideCsModule = provideCsModule;
    exports.ɵa = UciService;
    exports.ɵb = BaseService;
    exports.ɵc = GlobalService;
    exports.ɵd = ConfigService;
    exports.ɵe = TelemetryUtilsService;
    exports.ɵf = ComponentsModule;
    exports.ɵg = SidePanelComponent;
    exports.ɵh = ConversationListComponent;
    exports.ɵi = ConversationAddComponent;
    exports.ɵj = ToasterService;
    exports.ɵk = UserSegmentListComponent;
    exports.ɵl = UserSegmentAddComponent;
    exports.ɵm = UciGraphQlService;
    exports.ɵn = TermsConditionsComponent;
    exports.ɵo = TermsConditionConfirmComponent;
    exports.ɵp = ConversationSuccessComponent;
    exports.ɵq = LogicListComponent;
    exports.ɵr = ConversationSetupComponent;
    exports.ɵs = ExhaustReportComponent;
    exports.ɵt = PipesModule;
    exports.ɵu = PaginatorIntl;
    exports.ɵv = UciRoutingModule;
