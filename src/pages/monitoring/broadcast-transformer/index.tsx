...
interface BroadcastTransformerProps extends React.HTMLAttributes<HTMLDivElement> {
  theme: string;
}

export const BroadcastTransformer: React.FC<BroadcastTransformerProps> = ({ theme }) => {
