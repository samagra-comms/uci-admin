...
interface BroadcastTransformerLogsProps extends React.HTMLAttributes<HTMLDivElement> {
  theme: string;
}

export const BroadcastTransformerLogs: React.FC<BroadcastTransformerLogsProps> = ({ theme }) => {
  ...
  const fetchMessageData = async () => {
    ...
    try {
      ...
      const response = await fetchServiceData("broadcast-transformer", searchText, date);
